...
namespace CapaControlador
{
    public class ControladorJM
    {
        ...
        {
            OdbcDataReader Lector = Modelo.funcBuscarFactura(NumOrden);
            return Lector;
        }
        ...
        public DataTable funcBuscarOrdenes(int EstadoOrden)
        {
            OdbcDataAdapter dt = Modelo.funcBuscarOrdenes(EstadoOrden);
        ...
        public void funcInsertarFactura(string NumOrden, string Proveedor, string Empleado, string Empresa, string Sucursal, string Bodega, string FechaComp, string Total, string TipoC, string Metodo, string FechaFact,int Estado)
        {
            ...
            Modelo.funcInsertarFactura(NumOrden, Proveedor, Empleado, Empresa, Sucursal, Bodega, FechaComp, Total, TipoC, Metodo, FechaFact, Estado);
